...
type PrimitiveFormProps = PrimitivePropsWithRef<"form">;
...
type FormLabelElement = React.ComponentRef<typeof Primitive.label>;
type LabelProps = PrimitivePropsWithRef<"label">;
