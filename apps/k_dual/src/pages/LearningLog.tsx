import { Accordion, Button, Toast, Tooltip } from "@timeless-ui/ui";
import {
  ArrowLeft,
  CalendarCheck,
  CheckCircle,
    ...
    <Toast.Provider>
      <div className="min-h-screen bg-gray-50 font-sans text-gray-900 antialiased">
            ...
            <div className="mb-4 flex gap-4 rounded-2xl bg-white p-5 opacity-70 shadow-sm transition-all">
              ...
              <div className="flex flex-1 flex-col justify-center">
                ...
                <div className="mt-1 flex items-center justify-between">
                  <div
                    onClick={() => handleAction("강의자료 다운로드 시작")}
                    className="flex cursor-pointer items-center gap-1 text-[13px] text-gray-500 transition-colors hover:text-gray-900"
                  >
                    <Download size={14} /> 자료
                  </div>
            ...
            <div className="mb-4 flex gap-4 rounded-2xl border border-teal-600 bg-white p-5 shadow-[0_4px_12px_rgba(13,148,136,0.15)] transition-all">
              ...
              <div className="flex flex-1 flex-col justify-center">
                ...
                <div className="mt-1 flex items-center justify-between">
                  ...
                  <Button
                    onClick={() => handleAction("학습을 시작합니다")}
                    className="cursor-pointer rounded-lg border-none bg-teal-600 px-4 py-2 text-[13px] font-semibold text-white"
                  >
                    학습하기
                  </Button>
                </div>
            ...
            <div className="mb-4 flex gap-4 rounded-2xl bg-white p-5 shadow-sm transition-all">
              ...
              <div className="flex flex-1 flex-col justify-center">
                ...
                <div className="mt-1 flex items-center justify-between">
                  ...
                  <Tooltip.Root>
                    <Tooltip.Trigger className="cursor-not-allowed rounded-lg border-none bg-gray-200 px-4 py-2 text-[13px] font-semibold text-gray-400">
                      오픈예정
                    </Tooltip.Trigger>
                    <Tooltip.Portal>
                      <Tooltip.Content className="animate-in fade-in-0 zoom-in-95 z-50 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white shadow-md">
                        11월 24일에 오픈됩니다.
        ...
        <div className="mx-auto hidden max-w-[1200px] px-10 pb-20 md:block">
          ...
          <div className="grid grid-cols-[1fr_360px] items-start gap-10">
            ...
            <div className="flex flex-col">
              ...
              <Accordion.Root mode="single" collapsible className="flex flex-col gap-4">
                {/* Week 1 - Completed */}
                <Accordion.Item
                  value="week-1"
                  className="rounded-2xl bg-gray-50 shadow-sm transition-all hover:shadow-md"
                >
                  <Accordion.Header className="flex">
                    <Accordion.Trigger className="group flex w-full items-center gap-8 p-6 text-left">
                      <div className="min-w-15 flex flex-col items-center justify-center border-r border-gray-200 pr-8">
                      ...
                      <ChevronDown className="text-gray-400 transition-transform duration-200 ease-in-out group-data-[state=open]:rotate-180" />
                    </Accordion.Trigger>
                  </Accordion.Header>
                  <Accordion.Content className="data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown overflow-hidden bg-gray-50 px-6 text-sm">
                    <div className="border-t border-gray-200 pb-6 pt-4">
                      <p className="mb-4 text-gray-500">
                        PBL(Project Based Learning) 기반의 OJT 훈련 과정에 대한 전반적인 이해와 오리엔테이션을
                        진행합니다.
                      </p>
                      <div className="flex items-center gap-5">
                        <div
                          onClick={() => handleAction("강의자료 다운로드 시작")}
                          className="flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900"
                        >
                ...
                >
                  ...
                  <Accordion.Content className="data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown overflow-hidden bg-gray-50 px-6 text-sm">
                    <div className="border-t border-gray-200 pb-6 pt-4">
                      <p className="mb-4 text-gray-500">
                        중간 평가를 위한 제안서 포트폴리오를 작성하고 제출하는 주간입니다.
                      </p>
                      <div className="flex items-center gap-5">
                        <div
                          onClick={() => handleAction("강의자료 다운로드 시작")}
                ...
                <Accordion.Item
                  value="week-12"
                  className="rounded-2xl border border-teal-600 bg-white shadow-[0_4px_12px_rgba(13,148,136,0.15)] transition-all hover:shadow-md"
                >
                  <Accordion.Header className="flex">
                    <Accordion.Trigger className="group flex w-full items-center gap-8 p-6 text-left">
                      <div className="min-w-15 flex flex-col items-center justify-center border-r border-gray-200 pr-8">
                  ...
                  <Accordion.Content className="data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown overflow-hidden bg-white px-6 text-sm">
                    <div className="border-t border-gray-200 pb-6 pt-4">
                      <p className="mb-4 text-gray-500">이번 주차는 시스템 테스트와 보완이 주 내용입니다.</p>
                      <div className="flex items-center gap-5">
                        <div
                          onClick={() => handleAction("강의자료 다운로드 시작")}
                          className="flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900"
                        ...
                        <Button
                          onClick={() => handleAction("학습을 시작합니다")}
                          className="cursor-pointer rounded-xl border-none bg-teal-600 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-teal-700"
                        >
                          학습 시작하기
                        </Button>
                      </div>
                ...
                >
                  ...
                  <Accordion.Content className="data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown overflow-hidden bg-white px-6 text-sm">
                    <div className="border-t border-gray-200 pb-6 pt-4">
                      <p className="mb-4 text-gray-500">아직 오픈되지 않은 주차입니다.</p>
                      <div className="flex items-center gap-5">
                        <Tooltip.Root>
                          <Tooltip.Trigger className="cursor-not-allowed rounded-xl border-none bg-gray-200 px-6 py-2.5 text-sm font-semibold text-gray-400">
                            11월 24일 오픈
                          </Tooltip.Trigger>
                          <Tooltip.Portal>
                            <Tooltip.Content className="animate-in fade-in-0 zoom-in-95 z-50 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white shadow-md">
        ...
        <Toast.Root
          ...
          className="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2 flex w-[350px] items-start gap-3 rounded-xl border border-gray-100 bg-white p-4 shadow-lg"
        >
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-teal-50 text-teal-600">
            <CheckCircle2 size={18} />
          </div>
          <div className="flex-1">
            <Toast.Title className="mb-1 text-sm font-bold text-gray-900">알림</Toast.Title>
            <Toast.Description className="text-xs text-gray-500">{toastMessage}</Toast.Description>
          </div>
