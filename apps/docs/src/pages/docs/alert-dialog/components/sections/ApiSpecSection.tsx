...
const ApiSpecSection = () => (
  <section>
    ...
    {/* Content */}
    <Document.Heading2>Content</Document.Heading2>
    <Document.Paragraph>
      다이얼로그의 콘텐츠 영역입니다. role="alertdialog"와 aria-modal="true"가 자동으로 적용되어 접근성을 보장합니다.
    </Document.Paragraph>

    {/* Cancel / Action */}
    <Document.Heading2>Cancel / Action</Document.Heading2>
    <Document.Paragraph>
    ...
    {/* Primary Attributes */}
    <Document.Heading2>주요 속성</Document.Heading2>
    <Document.Paragraph>AlertDialog 컴포넌트에서 사용하는 주요 속성입니다.</Document.Paragraph>
